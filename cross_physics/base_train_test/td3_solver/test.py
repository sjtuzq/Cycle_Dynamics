...
def eval_policy(policy, env_name, seed, eval_episodes=10,model_path=None,imgpath=None):
    ...
    for i in range(eval_episodes):
        ...
        while not done:
            ...
            avg_reward += reward
            reward_r += reward
        buffer.append(reward_r)
        print(i,reward_r)
        np.save(os.path.join(model_path, 'transfer.npy'), np.array(buffer))
